...
app_publisher = "GKDevs"
app_description = "This is simple Gym Management System that enables tracking memberships, locker booking, group classes, professional trainer subscription"
